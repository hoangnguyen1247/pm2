...
class API {
    ...
    // in Containerizer.ts
    dockerMode: (cmd: string, opts: any, env: string) => void;

    // in Extra.ts
    trigger: (pmId: number, actionName: string, params: any, cb?) => void;
    getPID: (appName: string, cb?) => void;
    boilerplate: (cb?) => void;
    profile: (type: string, time: any, cb?) => void;
    inspect: (appName: string, cb?) => void;
    sendSignalToProcessName: (signal: string, processName: string, cb?) => void;
    sendSignalToProcessId: (signal: string, processId: string, cb?) => void;
    ping: (cb?) => void;

    // in Deploy.ts
    deploy: (file: string, commands: any, cb?) => void;

    // in Modules/index
    install: (moduleName: string, opts?: any, cb?) => void;
    uninstall: (moduleName: string, cb?) => void;
